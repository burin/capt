      ...
      return {
        ...
        load: function (name, parentRequire, load, config) {
          //>>excludeStart('excludeAfterBuild', pragmas.excludeAfterBuild)
            ...
            fetchOrGetCached( parentRequire.toUrl('templates/i18n/'+(config.locale || "en_us")+'.json'), function (langMap) {
              // if local stuff isn't set, 404 isn't caught, and JSON.parse gets passed whatever generic 404 server text is sent back
              try {
              ...
              fetchText(path, function (text) {
                  ...
                  // use a single helper file instead of trying to bring in individual ones.
                  // TODO: make this configurable
                  helpDepStr = ",'templates/helpers/all'";
                  if ( meta !== "{}" ) {
                    try {
